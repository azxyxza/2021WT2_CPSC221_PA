...
namespace filler
{
  ...
  */
  ...
  bool fillPix(OrderingStructure<PixelPoint> &os, filler::FillerConfig& config, vector<vector<filler::PixRecord>> &imgRecord, PNG *img);

  bool needFill(FillerConfig &config, HSLAPixel pix);

  bool withInImg(unsigned int x, unsigned int y, PNG *img);
} // namespace filler
